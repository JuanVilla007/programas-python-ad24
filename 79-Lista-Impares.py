...
nu = int(input("Cuantos numeros impares necesitas? "))
...
if bus in A:
    pos = A.index(bus)
    print(f"El elemento SI esta en la lista original y se encuentra en la posicion {pos} comenzando desde la posicion 0")
else:
    print("El elemento NO esta en la lista original")